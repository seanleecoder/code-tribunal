...
- Upgraded reviewer CLIs to Claude Code 2.1.280, Codex 0.156.1, OpenCode
  ...
  15.1.0. The reviewer image is smaller: it drops CLI copies and runtimes
  unused on Linux, with build guards that fail if a pin starts needing them,
  and keeps build-probe state such as Claude install IDs out of image layers.

...
and platform object IDs at every step. (The unrelated-line-movement step is
release-gating only for the *internal* remap, which is regression-covered; its
*platform-visible* re-anchoring is a live-optional confirmation — see the runbook.)

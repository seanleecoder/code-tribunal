...
| `scripts/check_docs.py` | Audit links, anchors, configuration/environment inventory, install examples, documented mock scenarios, and the code/config premises documents declare in `verified-claims` comments | 0 | 1 when the documentation contract fails |

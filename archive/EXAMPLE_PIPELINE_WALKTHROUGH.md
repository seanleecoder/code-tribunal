...
- **Trusted config at run time**: `critique.enabled=true`, `critique.rounds=1`, `allow_advisory_escalation=true`, `allow_severity_downgrade=true` (the permanently-enabled critique config; see PHASE_5_ACCEPTANCE.md)

...
reinterpret an older release or validate it against hashes from a newer branch.
The checked-in live file is the 1.0.1 draft. To validate a historical manifest,
use a worktree at that release's tag as described in the [release

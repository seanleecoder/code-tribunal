...
release is supported; there are no backports to earlier release lines.
Downstream users should use the latest reviewed release or immutable commit and
keep template/image pins from one publication run.
